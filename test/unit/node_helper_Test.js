...
describe("node_helper", () => {
    ...
    beforeEach(() => {
        ...
        helper = proxyquire(
            '../../node_helper',
            { 'node_helper': node_helper_fake, './Logger': LoggerFake, 'https': HttpsFake });
    });
    ...
    describe("socketNotificationReceived", () => {
        ...
        it("should set config and load data when notification is received", () => {
            ...
            // Assert
            assert.deepEqual(helper.config, { test: "data" });
    ...
    describe("fetchDayData", () => {
        ...
        it("should chunk xml data and parse on end of response", async () => {
            ...
            // Assert
            assert.equal(data, "chunk parsed");
        });
    ...
    describe("parseData", () => {
        ...
        it("should return weather data", () => {
            ...
            // Assert
            assert.deepEqual(data, { id: "2", test: "data" });
        });
